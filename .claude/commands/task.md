...
| 단계 | 역할 | 스킬 파일 |
|------|------|----------|
| Step 1 | Researcher | `.claude/skills/researcher/skill.md` |
| Step 2 | Planner | `.claude/skills/planner/skill.md` |
| Step 3 | Implementer | `.claude/skills/implementer/skill.md` |
| Step 4 | Reviewer | `.claude/skills/reviewer/skill.md` |
| Step 5 | QA | `.claude/skills/qa/skill.md` |
| Step 6 | Summarizer | `.claude/skills/summarizer/skill.md` |
...
프롬프트:
```
`.claude/skills/researcher/skill.md`를 읽고 그 내용에 따라 Researcher 역할을 수행하라.
...
프롬프트:
```
`.claude/skills/planner/skill.md`를 읽고 그 내용에 따라 Planner 역할을 수행하라.
...
**신규 구현 (기본):**
```
`.claude/skills/implementer/skill.md`를 읽고 그 내용에 따라 TDD 사이클로 구현하라.
...
```
`.claude/skills/implementer/skill.md`를 읽고 그 내용에 따라 수행하라.
...
```
`.claude/skills/reviewer/skill.md`를 읽고 그 내용에 따라 코드 리뷰를 수행하라.
...
```
`.claude/skills/qa/skill.md`를 읽고 그 내용에 따라 QA 시나리오를 검증하라.
...
```
`.claude/skills/summarizer/skill.md`를 읽고 최종 리포트를 작성하라.
